...
required to run a [Timelord](https://github.com/Pipscoin-Network/pipscoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Pipscoin-Network/pipscoin-blockchain/blob/main/install-timelord.sh)
