...
wallet_program_files = set(
    [
        ...
        "pipscoin/wallet/puzzles/p2_delegated_puzzle.clvm",
        "pipscoin/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "pipscoin/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "pipscoin/wallet/puzzles/p2_puzzle_hash.clvm",
        "pipscoin/wallet/puzzles/rl_aggregation.clvm",
        "pipscoin/wallet/puzzles/rl.clvm",
        "pipscoin/wallet/puzzles/sha256tree_module.clvm",
        "pipscoin/wallet/puzzles/singleton_top_layer.clvm",
        "pipscoin/wallet/puzzles/did_innerpuz.clvm",
        "pipscoin/wallet/puzzles/decompress_puzzle.clvm",
        "pipscoin/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "pipscoin/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "pipscoin/wallet/puzzles/block_program_zero.clvm",
        "pipscoin/wallet/puzzles/test_generator_deserialize.clvm",
        "pipscoin/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "pipscoin/wallet/puzzles/p2_singleton.clvm",
        "pipscoin/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
...
clvm_include_files = set(
    ["pipscoin/wallet/puzzles/create-lock-puzzlehash.clvm", "pipscoin/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "pipscoin/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to pipscoin/wallet/puzzles, but not added to `wallet_program_files`
        """
