...
The workflows are located in [../.github/workflows/](https://github.com/Pipscoin-Network/pipscoin-blockchain/tree/main/.github/workflows).
...
In the top tests directory, [testconfig.py](https://github.com/Pipscoin-Network/pipscoin-blockchain/tree/main/tests/testconfig.py)
...
Set `checkout_blocks_and_plots` to `False` to omit checking out the [test-cache](https://github.com/Pipscoin-Network/test-cache) repo.
