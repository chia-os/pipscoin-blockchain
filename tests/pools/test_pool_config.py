...
from pipscoin.pools.pool_config import PoolWalletConfig
from pipscoin.util.config import load_config, save_config, create_default_pipscoin_config
...
def test_pool_config():
    ...
    create_default_pipscoin_config(test_root, ["config.yaml"])
