...
from pipscoin.wallet.puzzles.p2_conditions import puzzle_for_conditions
from pipscoin.wallet.puzzles import singleton_top_layer
from pipscoin.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - pipscoin.pools.pool_puzzles.py
    - pipscoin.wallet.puzzles.pool_member_innerpuz.clvm
    - pipscoin.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("3af6e0d6c6a1da419561a832f69f23be905262f40f2eeadbeded167612b01f92")
