...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of pipscoin', () => {
      const result = units.getUnit('pipscoin');
    ...
    it('gets unit of pipscoin using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of pipscoin', () => {
      const result = units.getDisplay('pipscoin');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('pipscoin', 9);

      const result = units.getUnit('pipscoin');

      expect(result).toEqual(9);

      units.setUnit('pipscoin', 1);
    });
  });
  describe('#setDisplay', () => {
