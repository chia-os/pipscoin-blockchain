...
import icon from '../../assets/img/pipscoin_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Pipscoin Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Pipscoin-Network/pipscoin-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
