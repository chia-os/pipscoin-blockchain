...
import { CardHero, Flex, Link } from '@pipscoin/core';
import { PlotHero as PlotHeroIcon } from '@pipscoin/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Pipscoin. '
              }
              <Link
                target="_blank"
                href="https://github.com/Pipscoin-Network/pipscoin-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
