...
from pipscoin.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "pipscoin" in cc_discrepancies:
                    cc_discrepancies["pipscoin"] = cc_discrepancies["pipscoin"] + diff
                else:
                    cc_discrepancies["pipscoin"] = diff
