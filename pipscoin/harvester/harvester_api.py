...
from pipscoin.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from pipscoin.harvester.harvester import Harvester
from pipscoin.plotting.plot_tools import PlotInfo, parse_plot_info
from pipscoin.protocols import harvester_protocol
from pipscoin.protocols.farmer_protocol import FarmingInfo
from pipscoin.protocols.harvester_protocol import Plot
from pipscoin.protocols.protocol_message_types import ProtocolMessageTypes
from pipscoin.server.outbound_message import make_msg
...
from pipscoin.util.api_decorators import api_request, peer_required
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSPipscoinConnection
    ):
        """
