...
from pipscoin.farmer.farmer import Farmer
from pipscoin.protocols import farmer_protocol, harvester_protocol
from pipscoin.protocols.harvester_protocol import PoolDifficulty
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSPipscoinConnection
    ):
        """
