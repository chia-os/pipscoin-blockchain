...
from pipscoin.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from pipscoin.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from pipscoin.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from pipscoin.pools.pool_puzzles import (
...
from pipscoin.util.ints import uint8, uint32, uint64
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `pipscoin singleton` that is
