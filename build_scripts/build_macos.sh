...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Pipscoin-darwin-x64/Pipscoin.app --platform=darwin \
...
mv Pipscoin-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Pipscoin-$PIPSCOIN_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Pipscoin-darwin-x64/Pipscoin.app Pipscoin-$PIPSCOIN_INSTALLER_VERSION \
